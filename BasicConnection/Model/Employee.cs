...
public class Employee
{
    ...
    public void PrintOutEmployee()
    {
        ...
        var universityConnection = new University();
        var educationConnection = new Education();
        var profilingConection = new Profiling();

        universityConnection.InsertUniversity(university);
        education.UniversityId = GetUnivEduId(1);
        educationConnection.InsertEducation(education);

        profiling.EmployeeId = GetEmpId(niks);
        profiling.EducationId = GetUnivEduId(2);
        profilingConection.InsertProfiling(profiling);
    }
